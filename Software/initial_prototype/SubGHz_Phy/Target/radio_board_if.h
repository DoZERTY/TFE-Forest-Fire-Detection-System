...
#define RFIO_SEL_PIN                                                GPIO_PIN_13
#define RFIO_SEL_GPIO_PORT                                        GPIOC
#define RFIO_SEL_GPIO_CLK_ENABLE()                        __HAL_RCC_GPIOC_CLK_ENABLE()
#define RFIO_SEL_GPIO_CLK_DISABLE()                        __HAL_RCC_GPIOC_CLK_DISABLE()
