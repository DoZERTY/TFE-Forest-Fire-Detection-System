...
int main(void)
{
  ...
  // LPUART deactivation
  HAL_UART_DeInit(&hlpuart1);                   // Deinitialization HAL
  __HAL_RCC_LPUART1_CLK_DISABLE();              // Cut the clock
...
void MX_RTC_Init(void)
{
  ...
  */
  ...
  /** Enable the WakeUp
  */
  if (HAL_RTCEx_SetWakeUpTimer_IT(&hrtc, 39999, RTC_WAKEUPCLOCK_RTCCLK_DIV16, 0) != HAL_OK)
  {
    Error_Handler();
  }
