...
#warning user to provide its board code or to call his board driver functions
  ...
  HAL_GPIO_DeInit(RFIO_SEL_GPIO_PORT, RFIO_SEL_PIN);
...
#warning user to provide its board code or to call his board driver functions
  ...
  HAL_GPIO_WritePin(DRIVE_RF_Pin_GPIO_Port, DRIVE_RF_Pin_Pin, GPIO_PIN_SET);
  // notes: with one switch, only RX or TX => OFF=RX, HP=LP
